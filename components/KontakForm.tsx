    ...
    <div className="flex flex-col items-center gap-3">
      {units.map((u, i) => (
        ...
        >
          ...
          <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-green-50 flex items-center justify-center flex-shrink-0 group-hover:bg-green-100 transition-colors">
