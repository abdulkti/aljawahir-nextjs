...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* ===== HERO ===== */}
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 pb-16 overflow-hidden">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {strukturOrganisasi[0].orang.map((t, i) => (
                <div key={i} className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all text-center animate-in" style={{ animationDelay: `${0.1 + i * 0.15}s` }}>                  <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-green-600 to-green-800 flex items-center justify-center text-white font-bold text-xl mb-3" style={{ fontFamily: 'Lora, serif' }}>
                    {t.inisial}
                  </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-lg mx-auto">
              {strukturOrganisasi[1].orang.map((t, i) => (
                <div key={i} className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all text-center animate-in" style={{ animationDelay: `${0.1 + i * 0.15}s` }}>
          ...
          <div className="mb-12">
            ...
            <div className="max-w-xs mx-auto">
              {strukturOrganisasi[2].orang.map((t, i) => (
                <div key={i} className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all text-center animate-in">
                  <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-green-600 to-green-800 flex items-center justify-center text-white font-bold text-xl mb-3" style={{ fontFamily: 'Lora, serif' }}>
                    {t.inisial}
                  </div>
                  <p className="font-bold text-gray-800 text-sm leading-snug" style={{ fontFamily: 'Lora, serif' }}>{t.nama}</p>
