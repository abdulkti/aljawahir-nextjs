  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 pt-20 pb-16 overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-72 h-72 bg-yellow-400/5 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-emerald-400/5 rounded-full blur-3xl animate-float" />
        <div className="relative z-10 max-w-3xl mx-auto">
          <span className="inline-block bg-yellow-400/15 border border-yellow-400/30 text-yellow-300 text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-6 animate-fade-in">
            🌙 Al Jawahir Islamic School
          </span>
          <p className="arabic text-yellow-300 text-2xl md:text-3xl leading-loose mb-2 animate-fade-in-up" style={{ animationDelay: '0.15s', animationFillMode: 'both' }}>
          ...
          <p className="text-white/65 text-base md:text-lg leading-relaxed mb-10 max-w-xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.7s', animationFillMode: 'both' }}>
            Membangun Ilmu, Akhlak, dan Ummah melalui Pendidikan Islam yang berintegritas dan berdampak.
          </p>
          <div className="flex gap-4 justify-center flex-wrap animate-fade-in-up" style={{ animationDelay: '0.85s', animationFillMode: 'both' }}>
            <Link href="#program" className="bg-yellow-400 text-green-900 px-8 py-3.5 rounded-xl font-bold text-base hover:bg-yellow-300 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-yellow-400/25 no-underline">
              Lihat Program Kami
            </Link>
            <Link href="#tentang" className="border border-white/30 text-white px-8 py-3.5 rounded-xl font-bold text-base hover:bg-white/10 transition-all no-underline">
              Tentang Yayasan
            </Link>
          </div>
        </div>
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-float">
          <div className="w-5 h-8 rounded-full border-2 border-white/20 flex items-start justify-center p-1">
            <div className="w-1 h-2 rounded-full bg-white/40 animate-fade-in" />
          </div>
        </div>
      </section>

      {/* ===== STATS ===== */}
      <div className="bg-green-800 py-8 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent" />
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-px relative">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <AnimateOnScroll>
            <div className="relative">
              <div className="w-full h-96 rounded-2xl bg-gradient-to-br from-green-900 to-green-700 flex items-center justify-center overflow-hidden shadow-xl shadow-green-900/10">
                <span className="arabic text-9xl text-white/10 select-none">التربية</span>
              </div>
              <div className="absolute -bottom-4 -right-4 bg-yellow-400 rounded-2xl px-6 py-4 text-center shadow-xl hover:-translate-y-0.5 transition-transform">
      ...
      {/* ===== QUOTE ===== */}
      <AnimateOnScroll>
        <div className="bg-green-50 py-16 px-6 text-center relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.03]"
            style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='40' height='40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M20 0 L40 20 L20 40 L0 20 Z' fill='none' stroke='%23047857' stroke-width='1'/%3E%3C/svg%3E\")" }} />
          <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <AnimateOnScroll key={i} delay={(i + 1) as 0 | 1 | 2 | 3 | 4}>
                <div className="group border border-gray-200 rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-white hover:border-green-200">
                  ...
                  <div className="p-6">
                    <span className="text-xs font-bold uppercase tracking-wide text-green-700 bg-green-50 px-3 py-1 rounded-full group-hover:bg-green-100 transition-colors">{p.tag}</span>
                    <h3 className="font-bold text-gray-800 text-lg mt-3 mb-2 leading-snug" style={{ fontFamily: 'Lora, serif' }}>{p.title}</h3>
                    <p className="text-gray-500 text-sm leading-relaxed mb-4">{p.desc}</p>
                    <div className="flex flex-wrap gap-2 mb-4">{p.meta.map(m => <span key={m} className="text-xs bg-green-50 text-green-600 px-2.5 py-1 rounded-full group-hover:bg-green-100 transition-colors">{m}</span>)}</div>
      ...
      {/* ===== SEJARAH ===== */}
      <section id="sejarah" className="py-20 px-6 bg-green-900 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-start relative">
          <AnimateOnScroll>
            <div>
          ...
          <div className="relative pl-8">
            ...
            {[
              ...
              <AnimateOnScroll key={i} delay={(i + 1) as 0 | 1 | 2 | 3 | 4}>
                <div className="relative pb-10 last:pb-0 group">
                  <div className="absolute -left-10 top-1 w-4 h-4 rounded-full bg-yellow-400 border-4 border-green-900 shadow-[0_0_0_3px_#f59e0b] group-hover:scale-125 transition-transform" />
      ...
      <section id="kontak" className="py-20 px-6 bg-amber-50">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <AnimateOnScroll delay={2}>
            <div className="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 border border-green-100 shadow-lg shadow-green-900/5 flex flex-col justify-center relative overflow-hidden hover:shadow-xl hover:shadow-green-900/10 transition-shadow">
