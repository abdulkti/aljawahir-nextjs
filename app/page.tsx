            ...
            <div className="space-y-5">
              {[
                ...
                <div key={c.title} className="flex gap-4 items-start group">
                  <div className="w-11 h-11 rounded-xl bg-green-900 flex items-center justify-center text-lg flex-shrink-0 group-hover:bg-green-800 transition-colors">{c.icon}</div>
